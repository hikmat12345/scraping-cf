...
echo " +-++-++-++-++-++-+ +-++-++-++-++-+ +-++-+ +-++-++-+
Scrape findanyanswer questions from seed urls
+-++-++-++-++-++-+ +-++-++-++-++-+ +-++-+ +-++-++-+ \n";
...
$already_inserted_words_file_path = 'findanyanswer.com-inserted-question.txt';
...
while (($line = fgetcsv($csv_file)) !== FALSE) {
    ...
    if (stripos($already_inserted_words_file, $url) === FALSE) {
        ...
        if ($ret == "success") {
            ...
            $tags = "";
            foreach ($myhtml->find('.category .badge') as $e) {
