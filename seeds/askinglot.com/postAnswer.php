...
echo " +-++-++-++-++-++-+ +-++-++-++-++-+ +-++-+ +-++-++-+
Scrape askinglot questions from seed urls and post an answer
+-++-++-++-++-++-+ +-++-++-++-++-+ +-++-+ +-++-++-+ \n";
...
$csv_file_path = 'askinglot.com-inserted-question.txt';
$already_inserted_words_file_path = 'askinglot.com-inserted-answer.txt';
...
while (($line = fgetcsv($csv_file)) !== FALSE) {
 ...
 if ($ret == "success") {
        ...
        foreach ($myhtml->find('.answer p') as $body) {

            //  echo "---" . $body->tag . " --- \n";

            if (!((strpos($body->innertext, 'askinglot') !== false) || ($body->tag == "div") || (strpos($body->innertext, 'Click to see full answer') !== false))) {
                //    echo $body . "\n\n";
                //    echo "---" . $body . " --- \n";
                $content .=  $body ."<br>";
            }
